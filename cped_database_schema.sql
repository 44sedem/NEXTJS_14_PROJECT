...
-- ('Kudiabor Jonathan Kwabena Ewenam', 'M', '11254301', 'ewenamjonathan@gmail.com'),
...
-- ('Dabanka Hayet Maame Adwoa Gyasiwaa', 'F', '11353826', 'dabankahayet@gmail.com'),
...
-- UPDATE cped.students
-- SET student_number = '11254301', gender = 'M'
-- WHERE student_id = 40;

-- UPDATE cped.students
-- SET student_number = '11353826', gender = 'F' 
-- WHERE student_id = 59;
...
-- ('Agyare Debrah', 'Bamzy'),
-- ('Dr. Margaret Ansah Richardson', 'Foster'),
-- ('Dr. Godfrey Augustus Mills', 'Hakeem'),
-- ('Mr. John Asiammah', 'Foster'),
-- ('Agyare Debrah', 'Samed'),
-- ('Dr. John Kutor', 'Ben'),
